...
import { filterMaleProducts, filterFemaleProducts } from "../controllers/products.js";
...
export default (router) => {
    ...
    router.get('/products/male/:page', filterMaleProducts);
    router.get('/products/female/:page', filterFemaleProducts);
};